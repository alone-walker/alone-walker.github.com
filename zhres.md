...
<ul class="s1">
  ...
  <li><h2>工作经历</h2>
      <ul class="s2">
	      ...
	      <ul class="s3">
	          <li>公司主要产品为加密邮件系统，该系统在开源邮件服务器postfix的此基础上扩展开发了邮件的签名及加密功能.我主要负责了用于邮件签名的IE浏览器插件和postfix接收邮件时邮件验证的功能开发部分,熟悉了pki加密体系及IE插件开发,了解了邮件系统的架构,并有用python做过qmail邮件系统到postfix邮件系统的用户迁移工作
		  </li>
	      </ul>
	   </li>
